/**
 * This package holds pre-programmed concepts and facts that are accessible within Long Term Memory.
 * 
 * Many of the facts here are also pre-programmed into Processors, as pre-learned behaviour
 * that no longer needs the LTM reference.
 * 
 * However, the LTM reference can still be used when needed for higher-order reasoning.
 * 
