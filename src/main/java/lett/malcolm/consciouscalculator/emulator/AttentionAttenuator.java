...
public class AttentionAttenuator {
	 ...
	 */
	public boolean act(List<InputInterceptorResult> interceptorResults, List<ProcessorResult> processorResults) {
		// special handling - immediately apply action events
		for (ProcessorResult processorResult: processorResults) {
		...
		for (InputInterceptorResult interceptorResult: interceptorResults) {
